...
const price = ref(crypto.price);
const series = await useCrypto().getOneYearCrypto(crypto?.id);
</script>
  ...
  <div class="flex flex-col gap-8">
    <div class="flex flex-col gap-4">
      ...
      <div style="--stagger: 2; --delay: 100ms" data-animate class="flex flex-col gap-2">
        ...
        <div class="flex flex-row gap-2 items-center text-sm font-medium font-sans"
          :class="variations.value > 0 ? 'positive' : 'negative'">
          <div class="flex flex-row gap-1 items-center">
            <UIcon name="i-heroicons-arrow-down-circle-solid" class="w-5 h-5 transition-transform"
              :class="[variations.value > 0 && 'transform rotate-180']" />
    ...
    <ChartLine style="--stagger: 3; --delay: 100ms" data-animate @update:currentValue="price = $event"
      :cryptoData="series" @update:variation="variations = $event" />
